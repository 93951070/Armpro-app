...
public abstract class V3SchemeVerifier {
     ...
     * @throws SignatureNotFoundException if no APK Signature Scheme v3 signatures are found
    ...
    /**
     * Parses each signer in the provided APK Signature Scheme v3 block and populates
     ...
     * taken from {@code v3SchemeSignerInfos} of the provided {@code result}.
     */
    private static void verifyIntegrity(
        ...
        try {
            actualContentDigests =
                    V3SchemeSigner.computeContentDigests(
    ...
    /**
     * APK Signature Scheme v3 block and additional information relevant to verifying the signatures
     * contained in the block against the file.
     */
    private static class SignatureInfo {
        /** Contents of APK Signature Scheme v3 block. */
    ...
    private static SignatureInfo findSignature(
        ...
        // Find the APK Signature Scheme v3 Block inside the APK Signing Block.
        ByteBuffer apkSignatureSchemeV3Block =
                findApkSignatureSchemeV3Block(apkSigningBlockBuf, result);
    ...
    private static ByteBuffer findApkSignatureSchemeV3Block(
        ...
        throw new SignatureNotFoundException(
                "No APK Signature Scheme v3 block in APK Signing Block");
    }
    ...
    public static class Result {
        ...
        /** Whether the APK's APK Signature Scheme v3 signature verifies. */
